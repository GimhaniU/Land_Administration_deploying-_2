...
public class FrontPage extends javax.swing.JFrame {
    ...
    private JDialog AboutusDialog = new JDialog (this,"About Us",false);
    private AboutUsFrame aboutusPanel  = new AboutUsFrame();
    ...
    private FrontPage() {
        ...
        ImageIcon icon1 = new ImageIcon(getClass().getResource("/las/icons/logo-LAS-s.png"));
    ...
    private void initComponents() {
        ...
        systemMenu1 = new javax.swing.JMenu();
        changePasswordMenu1 = new javax.swing.JMenuItem();
        createNewUserMenu1 = new javax.swing.JMenuItem();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/las/icons/logo-LAS-Copy.png"))); // NOI18N
        ...
        systemMenu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/las/icons/System.png"))); // NOI18N
        systemMenu1.setText("About");

        changePasswordMenu1.setText("About Us");
        changePasswordMenu1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                changePasswordMenu1ActionPerformed(evt);
            }
        });
        systemMenu1.add(changePasswordMenu1);

        createNewUserMenu1.setText("Help");
        createNewUserMenu1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                createNewUserMenu1ActionPerformed(evt);
            }
        });
        systemMenu1.add(createNewUserMenu1);
        systemMenu1.add(jSeparator2);

        jMenuBar1.add(systemMenu1);
    ...
    private void changePasswordMenu1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changePasswordMenu1ActionPerformed
        // TODO add your handling code here:
        JDialog.setDefaultLookAndFeelDecorated(true);
        AboutusDialog.setContentPane(aboutusPanel);
        AboutusDialog.pack();
        AboutusDialog.setVisible(true);
    }//GEN-LAST:event_changePasswordMenu1ActionPerformed

    private void createNewUserMenu1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createNewUserMenu1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_createNewUserMenu1ActionPerformed
    ...
    private javax.swing.JMenu systemMenu1;
