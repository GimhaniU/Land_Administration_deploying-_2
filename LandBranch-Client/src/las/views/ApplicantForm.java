...
public class ApplicantForm extends javax.swing.JInternalFrame {
    ...
    public ApplicantForm() {
        ...
        try {
            ...
            regno = ClientController.getLastAddedClient().getRegNo() + 1;
    ...
    private void edit_update_buttunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edit_update_buttunActionPerformed
        ...
        if (showConfirmDialog == 0) {
            ...
            if (!PatternChecker.checkStringdirect(edit_nameText.getText())) {
                ...
                editincomenotvalidlabel.setVisible(true);
            } else if (edit_nameText.getText().trim().length() != 0 && edit_telephoneText.getText().trim().length() != 0 && edit_addressText.getText().trim().length() != 0 && edit_marided_sons.getText().trim().length() != 0 && edit_unmarried_sons.getText().trim().length() != 0 && edit_annualIncome.getText().trim().length() != 0 && (edit_marriedStatusRButton.isSelected() || edit_singleStatusRButton.isSelected())) {
                try {
